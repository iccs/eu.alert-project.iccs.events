...
public class StardomIdentityUpdatePayload{
    ...
    private StardomIdentityUpdateEvent eventData;

    public StardomIdentityUpdateEvent getEventData() {
        return eventData;
    }

    public void setEventData(StardomIdentityUpdateEvent eventData) {
        this.eventData = eventData;
    }

    @XStreamAlias("ns1:eventData")
    public static class StardomIdentityUpdateEvent implements Serializable {
